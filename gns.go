...
const (
	ResourceTypeTexture      ResourceType = 0x1701
	ResourceTypePrimaryMesh  ResourceType = 0x2E01
	ResourceTypeOverrideMesh ResourceType = 0x2F01
	ResourceTypeAltMesh      ResourceType = 0x3001
	ResourceTypeIgnore       ResourceType = 0x3101
)
...
func (r GNSRecord) Offset() int64 {
	sector := int64(binary.LittleEndian.Uint16(r[8:10]))
...
func (r GNSRecord) Type() ResourceType {
	return ResourceType(int(binary.LittleEndian.Uint16(r[4:6])))
}
